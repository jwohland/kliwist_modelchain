...
for i, luhmodel in enumerate(["IMAGE", "MINICAM", "MESSAGE"]):
    ...
    axs[i].set_title(luhmodel + ", rcp"+["2.6", "4.5", "8.5"][i])  # mapping from IAM to RCP based on Hurtt et al. 2011 (DOI 10.1007/s10584-011-0153-2)Table 1

plt.savefig("../plots/LUH/diff_landuse.png", dpi=300)
